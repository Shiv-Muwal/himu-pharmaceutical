...
export function AdminPreloader() {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[200] flex items-center justify-center overflow-hidden bg-[#eef8cd]"
    >
      ...
      <div className="relative z-10 flex flex-col items-center px-6 text-center">
        ...
        <div className="mt-4 h-1.5 w-32 overflow-hidden rounded-full bg-primary/10">
          <motion.div
            className="h-full rounded-full bg-gradient-to-r from-primary via-[#ffc5aa] to-primary"
            initial={{ x: "-100%" }}
            animate={{ x: "100%" }}
