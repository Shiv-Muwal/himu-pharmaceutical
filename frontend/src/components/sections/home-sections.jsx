...
export function BrandStoryHero() {
  ...
  return (
    <section className="relative min-h-[88svh] overflow-hidden md:min-h-[92svh]">
      ...
      <div className="absolute inset-y-0 left-0 hidden w-1/2 bg-gradient-to-r from-[#14532D]/45 to-transparent md:block" />
...
export function OverviewSection() {
  return (
    <section className="relative overflow-hidden section-padding">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_15%_20%,rgba(187, 247, 208,0.08),transparent_45%),radial-gradient(ellipse_at_90%_80%,rgba(214, 176, 77,0.1),transparent_40%)]" />
      <div className="container-custom relative">
        <div className="grid items-stretch gap-10 lg:grid-cols-12 lg:gap-14">
          <FadeIn direction="left" className="lg:col-span-5">
            <div className="relative h-72 overflow-hidden sm:h-96 lg:h-full lg:min-h-[520px]">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#14532D]/85 via-[#14532D]/25 to-transparent" />
          ...
          <FadeIn direction="right" className="lg:col-span-7">
            <h2 className="mb-5 max-w-xl font-[family-name:var(--font-heading)] text-3xl font-bold leading-[1.15] text-foreground md:text-4xl lg:text-[2.75rem]">
              ...
              <span className="mt-2 block text-emerald">
            ...
            <div className="mb-9 space-y-5 border-l-2 border-gold/50 pl-5">
              {OVERVIEW_PILLARS.map((pillar, i) => {
                ...
                return (
                  ...
                  >
                    <div className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center bg-primary/10 text-emerald">
              ...
              <Link href={`/categories/${cat.slug}`}>
                <Card className="group overflow-hidden h-full hover:shadow-2xl hover:shadow-primary/10">
                  ...
                  <CardContent className="p-5">
                    ...
                    <span className="inline-flex items-center gap-1 text-emerald text-sm font-semibold mt-3 group-hover:gap-2 transition-all">
...
export function WhyChooseSection() {
  return (
    <section className="relative overflow-hidden section-padding bg-[#BBF7D0]">
      ...
      <div className="container-custom relative">
        <div className="mb-10 max-w-2xl">
          <h2 className="font-[family-name:var(--font-heading)] text-3xl font-bold leading-tight text-primary-foreground md:text-4xl">
            ...
            <span className="mt-2 block text-emerald">choose HIMU Pharmacy</span>
          </h2>
          <p className="mt-4 text-sm leading-relaxed text-emerald/80 md:text-base">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
          {whyChoose.map((item, i) => (
            <FadeIn key={item.title} delay={i * 0.08}>
              <div className="group h-full border border-emerald/10 bg-white/55 p-6 backdrop-blur-sm transition hover:border-emerald/30 hover:bg-white/80">
                <div className="mb-4 flex h-11 w-11 items-center justify-center bg-emerald/10 text-emerald transition group-hover:bg-emerald group-hover:text-white">
                  <item.icon className="h-5 w-5" />
                </div>
                <h3 className="mb-2 font-[family-name:var(--font-heading)] text-lg font-bold text-primary-foreground">
                  {item.title}
                </h3>
                <p className="text-sm leading-relaxed text-emerald/75">
                  {item.description}
                </p>
              </div>
            </FadeIn>
    ...
    <section className="relative overflow-hidden section-padding bg-gradient-to-b from-[#f8f3e6] via-[#f3f7f0] to-[#f8f3e6]">
      ...
      <div className="container-custom mb-8 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
        <div className="max-w-xl">
          <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-primary/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-emerald">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full border border-primary/20 bg-primary/5 px-3 py-1 text-[11px] font-bold text-emerald">
              Add to cart · Buy now
            </span>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full border border-border/60 bg-white text-emerald shadow-sm transition hover:bg-primary hover:text-primary-foreground"
              ...
              <Link href={`/news/${post.slug}`}>
                <Card className="group overflow-hidden h-full hover:shadow-xl">
                  ...
                  <CardContent className="p-5">
                    ...
                    <h3 className="font-bold mb-2 group-hover:text-emerald transition-colors line-clamp-2">
                      {post.title}
                    </h3>
                    <p className="text-sm text-muted-foreground line-clamp-2">
                      {post.excerpt}
        ...
        <div className="animate-marquee flex gap-6 md:gap-8 items-center pointer-events-auto py-2">
          {duplicatedLogos.map((name, i) => {
            ...
            return (
              ...
              >
                <div className="h-9 w-9 rounded-xl bg-primary/10 text-emerald flex items-center justify-center group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
                  <Icon className="h-5 w-5" />
                </div>
                <span className="text-sm font-semibold text-foreground group-hover:text-emerald transition-colors">
                  {name}
                </span>
              </div>
            );
